package com.gs.common.algorithm;

import java.security.InvalidParameterException;
import java.security.SecureRandom;

/**
 * SM4对称加密算法：明文、密钥、密文都是16字节
 * 国家密码局2012年发布的分组密码标准，密钥长度和分组长度均为128位
 * 基本过程是首先把16字节密钥按照4字节一组分成4组，然后根据密钥扩展算法，生成32组4字节轮密钥；
 * 再把输入的16字节明文也按照4字节一组分成4组，然后进行循环运算（这点和AES算法类似）
 * 原理：参考https://blog.csdn.net/weixin_37569048/article/details/94983841
 * 规范：GB/T 32907-2016 SM4分组密码算法
 */
public class SM4 {
    /**
     * S盒，用于非线性变换t的计算
    ...
    /**
     * 加密算法与密钥扩展算法均采用非线性迭代结构，运算轮数均为 32 轮
     */
