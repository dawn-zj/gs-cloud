...
<template>
  <div>
    <div :id="containerId" ref="ref-color-picker-container" class="color-picker-container" :class="{'active':isShowPicker}">
      <div ref="ref-color" class="color" />
      <div ref="ref-wheel" class="wheel" />
      <div ref="ref-overlay" class="overlay" />
      <div ref="ref-h-marker" class="h-marker marker" />
      <div ref="ref-sl-marker" class="sl-marker marker" />
    </div>
  </div>
</template>
