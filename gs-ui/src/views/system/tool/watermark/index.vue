<template>
  <div class="container">
    <div :key="key">
              ...
              <li>
                ...
                <div>
                  ...
                  <color-picker
                    ref="ref-colorPicker"
                    :color="item.color"
                    :target-elem="'#color-input'+item.index"
      ...
      <div ref="ref-result-container" class="result-container">
        <div ref="ref-img-container" class="img-container">
          <img :src="imgUrl" alt>
          <template v-if="form.layout=='2'">
            <template v-for="item in markList">
              <div ref="ref-name" :key="item.index" class="name-box">
                <div ref="ref-name-rotate" class="name-rotate">
                  <span
                    draggable="true"
