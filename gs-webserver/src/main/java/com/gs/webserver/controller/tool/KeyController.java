...
public class KeyController {
    ...
    /**
     * 生成RSA密钥对
     * @param keySize 密钥长度，支持1024,2048
     * @return
     * @throws Exception
     */
    @PostMapping("/genRsaKeyPair")
    public ResponseTo<KeyResTo> genRsaKeyPairTest(int keySize) throws Exception {
    ...
    public ResponseTo<CommonResTo> rsaEncryptTest(String plain, String publicKeyB64) throws Exception {
        // 加载RSA公钥
    ...
    public ResponseTo<CommonResTo> rsaDecryptTest(String encryptB64, String privateKeyB64) throws Exception {
    ...
    public ResponseTo<CommonResTo> rsaRawSignTest(String plain, String privateKeyB64, String signHashAlg) throws Exception {
        // 加载RSA私钥
        PrivateKey privateKey = RSAUtil.generateP8PrivateKey(Base64Util.decode(privateKeyB64));
     ...
     * @param signB64 裸签值
     * @param publicKeyB64 公钥
     * @param signHashAlg 签名摘要算法
     * @return 验签结果
     * @throws Exception
     */
    @PostMapping("/rsaRawVerify")
    public ResponseTo<Boolean> rsaRawVerifyTest(String plain, String signB64, String publicKeyB64, String signHashAlg) throws Exception {
    ...
    public ResponseTo<CommonResTo> encryptWithBC(String plain, String publicKeyB64) throws Exception {
        // bc库sm2加密
    ...
    public ResponseTo<CommonResTo> decryptWithBC(String encryptB64, String privateKeyB64) throws Exception {
        byte[] encrypt = Base64Util.decode(encryptB64);
        // bc库sm2解密
    ...
    public ResponseTo<CommonResTo> encryptWith0009(String plain, String publicKeyB64) throws Exception {
        // bc库sm2加密
        PublicKey publicKey = SM2Util.createPublicKey(publicKeyB64);
    ...
    public ResponseTo<CommonResTo> decryptWith0009(String encryptB64, String privateKeyB64) throws Exception {
        byte[] encrypt = Base64Util.decode(encryptB64);
        // bc库sm2解密
        PrivateKey privateKey = SM2Util.createPrivateKey(privateKeyB64);
     ...
     * @param cipherMode GB/T 0003的密文格式，0:C1||C2||C3，1:C1||C3||C2
     * @return
     * @throws Exception
     */
    @PostMapping("/sm20003To0009")
    public ResponseTo<CommonResTo> sm20003To0009(String encB64, int cipherMode) throws Exception {
     ...
     * @param cipherMode GB/T 0003的密文格式，0:C1||C2||C3，1:C1||C3||C2
     * @param c1with04 C1部分是否带04
     * @return
     * @throws Exception
     */
    @PostMapping("/sm20009To0003")
    public ResponseTo<CommonResTo> sm20009To0003(String encB64, int cipherMode, boolean c1with04) throws Exception {
    ...
    public ResponseTo<CommonResTo> makeEnvelop(@RequestParam("file") MultipartFile pfxFile, String password, String plain) throws  Exception {
    ...
    public ResponseTo<CommonResTo> parseEnvelop(@RequestParam("file") MultipartFile pfxFile, String password, String envB64) throws Exception {
